...
export const ENEMY_FOODS: FoodDefinition[] = [
  ...
  // Snack enemies — common temptations
  { type: 'snack', faction: 'enemy', name: 'Popcorn Phantom', sprite: '🍿', color: '#fbbf24', glowColor: '#fde047', glucoseImpact: -5, basePoints: 10, spawnWeight: 12,
    effects: { energy: 4, hydration: -6, nutrition: -4, stability: -5 } },
  { type: 'snack', faction: 'enemy', name: 'Waffle Warlock', sprite: '🧇', color: '#d97706', glowColor: '#f59e0b', glucoseImpact: -9, basePoints: 15, spawnWeight: 8,
    effects: { energy: 10, hydration: -3, nutrition: -6, stability: -7 } },
  { type: 'snack', faction: 'enemy', name: 'Pancake Plague', sprite: '🥞', color: '#b45309', glowColor: '#d97706', glucoseImpact: -8, basePoints: 14, spawnWeight: 8,
    effects: { energy: 9, hydration: -2, nutrition: -5, stability: -7 },
    timeModifiers: { morning: 0.7, midday: 1.0, afternoon: 1.2, evening: 1.3 } },
];
...
export const MODE_PLOT_TWISTS: Record<UserMode, PlotTwist[]> = {
  personal: [
    ...
    },
    {
      ...
      name: 'Fiber First!',
      icon: '🥬',
      description: 'Eating fiber before carbs reduces glucose spikes!',
      duration: 10,
      effect: {},
      bonusCondition: 'Consume vegetables first for 3x points!',
      optimalActions: ['consume'],
    },
    {
      ...
      icon: '🏜️',
      description: 'Low fluids concentrate blood sugar!',
      duration: 8,
      effect: { hydration: -20, stability: -8 },
      ongoingEffect: { hydration: -2 },
      bonusCondition: 'Water and hydrating foods give 3x points!',
      optimalActions: ['consume'],
    },
    {
      id: 'social_lunch',
      name: 'Social Lunch!',
      icon: '🍽️',
      description: 'Friends ordering tempting food — stay strong!',
      duration: 10,
      effect: {},
      bonusCondition: 'Share healthy foods for 4x points! Reject junk for 2x!',
      optimalActions: ['share', 'reject'],
      shareBonus: true,
    },
  ],
  caregiver: [
